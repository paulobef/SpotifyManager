            ...
            HStack {
                ...
                VStack(alignment: .leading) {
                    Text("\(playlist.name)")
                        .bold()
                        .font(.title3)
                    if let unwrappedFollowers = playlist.followers {
                        Text("\(playlist.items.total) items - \(unwrappedFollowers.total) followers")
                    } else {
                        Text("\(playlist.items.total) items")
                    }
